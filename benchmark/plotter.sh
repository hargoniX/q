...
python plotter.py --mode time --duration 30 --variant pelletier -f pelletier.toml
python plotter.py --mode time --duration 30 --variant casc24
python plotter.py --mode time --duration 10 --variant casc29
python plotter.py --mode time --duration 30 --variant pelletier -f theorems.toml
